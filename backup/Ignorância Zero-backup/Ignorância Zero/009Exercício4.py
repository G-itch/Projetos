...
litros = (area / 6)
litrost = int(litros + (litros/100*10)) + 1
tinta1 = 18
tinta2 = 4
p1 = 80
p2 = 25
...
if lata2 == 1:
    ...
    print("você precisará de",lata2,"galões de",tinta2,"litros, custando",p2,"reais. Dando no total",pt2,"reais")
print("ou")
print("você precisará de",lata3,"latas de tinta de",tinta1,"litros, custando",p1,"reais e",lata4,"galões de",tinta2,"litros, custando",p2,"reais.\nDando no total",pt3,"reais")
